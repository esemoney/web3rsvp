...
contract Web3RSVP {
    ...
    //  Solidity events are a way for our subgraph to listen for specific actions to enable us to make queries about the data from our smart contract. they are emitted in their corresponding functions. events are written at the tippy top of the file, right after the contract declaration. so jump up hehe :)
}
